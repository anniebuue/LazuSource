...
class TitleState extends MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		...
		if (initialized && !transitioning && skippedIntro)
		{
			if(pressedEnter)
			{
				if(titleText != null) {titleText.animation.play('press'); titleText.centerOffsets();}
	...
	var hahafunny:Bool = FlxG.random.bool(10);
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 5:
					#if PSYCH_WATERMARKS
					var text1 = hahafunny ? ['I Just'] : ['You', 'Have'];
					createCoolText(text1, -40);
					#else
					createCoolText(['Have', 'No'], -40);
					#end
				case 7:
					var text2 = hahafunny ? 'Shit My Ass' : 'No Pomus?';
					addMoreText(text2, -40);
					ngSpr.visible = true;
				// credTextShit.text += '\nNewgrounds';
				case 8:
					deleteCoolText();
