...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['TIP', 'jeezus',	'Main Menu BG Artist',	'https://twitter.com/FlimsyTipsy',	'2266c0'],
			['cooper',	'cooper', 'Character Portrait Artist', '',	'ffc100'],
			['Agora', 'agora',	'Character Portrait Designer',	'',	'eb6116'],
			['Neyecole',	'neyecole', 'Background Artist',	'https://twitter.com/neyecoled',	'935e40'],
			['Professor Nobu',	'Nobu',	'Background Art Designer',	'https://twitter.com/nobu_okt',	'c6f4fe'],
			['Maarble', 'Maarble', 'Musician', 'https://www.youtube.com/channel/UCTmBhasnypdfoBUe3bpSb5g', 'fd97ac'],
			['Eivesohn',	'Eivesohn',	'Musician',	'https://www.youtube.com/c/eivesohn',	'96061c'],
			['CoolStalker',	'haysoos',	'Charter',	'https://twitter.com/TheCoolStalker',	'0b16cb'],
			['GGalactigal',	'Haruka',	'Improved Chromatics',	'https://twitter.com/GGalactigal',	'ed157c'],
			['Psych Engine Team'],
