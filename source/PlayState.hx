...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['PP Energy!', 1], //From 90% to 99%
		['Sheeesh!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	public function endSong():Void
	{
		...
		if(achievementObj != null) {
			...
			var achieve:String = checkForAchievement(['week1_nomiss', 'week2_nomiss', 'week3_nomiss', 'week4_nomiss',
				...
				'ur_good', 'hype', 'two_keys', 'toastie', 'debugger', 'pomu']);
			...
			if(!Achievements.isAchievementUnlocked(achievementName) && !cpuControlled) {
				...
				switch(achievementName)
				{
					...
					case 'debugger':
						...
						case 'pomu':
						if(Paths.formatToSongPath(SONG.song) == 'fresh' && !usedPractice) {
							unlock = true;
						}
							case 'finana':
						if(Paths.formatToSongPath(SONG.song) == 'Milf' && !usedPractice) {
							unlock = true;
						}
				}
